...
export const patienceSwitchIds = ["single_x_single_patience_switch","single_x_double_patience_switch","double_x_double_patience_switch","single_x_triple_patience_switch","double_x_triple_patience_switch","custom_x_digit_patience_switch"];
export const toToggleForDeviceIds = ["navigation_panel"]
export const seeMemorizeWriteIds = ["RAM_single","RAM_double","RAM_triple","RAM_mixed"];
